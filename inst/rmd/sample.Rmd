...
```{r ripley_by_gene, echo=FALSE, eval=TRUE, fig.width = 7, fig.height = round(length(feat_names(st_grid))/plot_rip_k_params$ncol, 0) * params$image_height / 2 }
plot_rip_k_params$feature <- feat_names(st_grid)
do.call(eval(parse(text="STarlight::plot_rip_k")), 
        plot_rip_k_params) 
```
...
```{r ripley_l, echo=FALSE, eval=TRUE, fig.width = 7, fig.height = 5 }
STarlight::set_verb_level(0)
...
```{r ripley_l_by_gene, echo=FALSE, eval=TRUE, fig.width = 7, fig.height = round(length(feat_names(st_grid))/plot_rip_k_params$ncol, 0) * params$image_height / 2 }
plot_rip_k_params$object <- st_grid
plot_rip_k_params$feature <- feat_names(st_grid)
do.call(eval(parse(text="STarlight::plot_rip_k")), 
        plot_rip_k_params) 
...
```{r moran_i, echo=FALSE, eval=TRUE, fig.width = 7, fig.height = 5}
STarlight::set_verb_level(0)
