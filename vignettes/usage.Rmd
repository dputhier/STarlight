...
```{r gene_colocalization, warning=FALSE, results='hide', echo = TRUE, eval=TRUE, fig.height=3, fig.width=4}
hc_st <- hc_tree(
  st_obj,
  method = "ward.D",
  layout = "circular",
...
We can map these genes to see how they differ across conditions using the `cmp_images()` function:
