...
```{r gene_contrast, warning=FALSE, results='hide', echo = TRUE, eval=TRUE, fig.height=2, fig.width=7}
gene_contrast(
  st_obj,
  feat_list_1 = c("Nwd2",
                  "Kctd8",
...
```{r multi_gene_contrast, warning=FALSE, results='hide', echo = TRUE, eval=TRUE, fig.height=2, fig.width=5}
multi_gene_contrast(
  st_obj,
  feat_list = c("Ebf3",
                "Kctd8",
...
p2 <- p1 + create_hull(st_obj, feat = "Nwd2_cpt", color="grey")  + gg_theme
p1 + p2
```
...
spatial_image(st_obj, "Cpne4") + create_hull(st_obj, 
                                             feat = "Nwd2_cpt_ngb", 
                                             linewidth = .3, color="white") + gg_theme
```
...
spatial_image(st_obj, features = meta_names(st_obj)[-c(1:3)], ncol = 4) + gg_theme
```
