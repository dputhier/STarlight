...
```{r gene_contrast, warning=FALSE, results='hide', echo = TRUE, eval=TRUE, fig.height=2.5, fig.width=5}
gene_contrast(
  st_obj,
  feat_list_1 = c("Nwd2",
                  "Kctd8",
...
```{r multi_gene_contrast, warning=FALSE, results='hide', echo = TRUE, eval=TRUE, fig.height=2.5, fig.width=4}
multi_gene_contrast(
  st_obj,
  feat_list = c("Ebf3",
                "Kctd8",
