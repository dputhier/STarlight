...
```{r gene_colocalization, warning=FALSE, results='hide', echo = TRUE, eval=TRUE, fig.height=5, fig.width=6}
hc_st <- hc_tree(
  st_obj,
  method = "ward.D",
  layout = "circular",
...
```{r cmp_boxplot, warning=FALSE, results='hide', echo = TRUE, eval=TRUE, fig.height=3, fig.width=5}
